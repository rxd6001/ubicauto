...
# from UBiC_Rotate_data import gb, cp1, upbit3
...
while True:
    ...
    bl, avg_p, tb = gb(upbit3)
    # bl = gb(upbit3)[0]
    # avg_p = gb(upbit3)[1]
    plus_profit = {}
    # cu_p = cp1()   
    # ext_s = ['KRW-VTHO', 'KRW-XYM']  # 전체 종목과 현재가 dict 'cu_p' 로 바인딩
    ...
    try:
        ...
        plus_profit = sorted(plus_profit.items(), key=lambda profit: profilt[1], reverse=True)
