                    ...
                    if sell_cont == 0:          # (0) 전체 매도 제외, 전체 추매 제외
                        ...
                        if (sell_cont == 1) or (sell_cont == 3):          # 추매기능
                            if e in ext_a:
                                ...
                                ag_price10 = (sum9 - plus_m) * ag10             # ag_price9 : 3,494,400
                                ...
                                # elif (an == 0) and (an < ap) and (5000 < t_money < (b_money * 1.1)) and (price < addprice_1) and (0.1 < addprice_1) and (5000 <= ag_price1) and (t_money < l_money) and (ag_price1 < summ):     # price: 종목현재가
                                    ...
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(0)-{now}:종목-1:{e}, 매수금액:{ag_price1}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, 현재가:{price}, 1차추매가격:{addprice_1}', file=fw)
                                ...
                                # elif (an == 1) and (an < ap) and (t_money < sum2) and (price < addprice_2) and (0.1 < addprice_2) and (5000 <= ag_price2) and (t_money < l_money) and (ag_price2 < summ):
                                    ...
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(1)-{now}:종목-2:{e}, 매수금액:{ag_price2}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, p:{price}, 2차추매가격:{addprice_2}', file=fw)
                                ...
                                # elif (an == 2) and (an < ap) and (t_money < sum3) and (price < addprice_3) and (0.1 < addprice_3) and (5000 <= ag_price3) and (t_money < l_money)  and (ag_price3 < summ):
                                    ...
                                    # upbit.buy_market_order(e, ag_price3)
                                    tb = ag_price3 / price          # volume : 매수수량 = 매수금액 / 현재가
                                    upbit.buy_limit_order(e, price, tb)         # 현재가 추매
                                    add_rw3(e, id); time.sleep(1)
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(2)-{now}:종목-3:{e}, 매수금액:{ag_price3}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, p:{price}, 3차추매가격{addprice_3}', file=fw)
                                    ...
                                    # upbit.buy_market_order(e, ag_price4)
                                    tb = ag_price4 / price          # volume : 매수수량 = 매수금액 / 현재가
                                    upbit.buy_limit_order(e, price, tb)         # 현재가 추매
                                    add_rw4(e, id); time.sleep(1)
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(3)-{now}:종목-4:{e}, 매수금액:{ag_price4}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, p:{price}, 4차추매가격{addprice_4}', file=fw)
                                    ...
                                    # upbit.buy_market_order(e, ag_price5)
                                    tb = ag_price5 / price          # volume : 매수수량 = 매수금액 / 현재가
                                    upbit.buy_limit_order(e, price, tb)         # 현재가 추매
                                    add_rw5(e, id); time.sleep(1)
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(4){now}:종목-5:{e}, 매수금액:{ag_price5}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, p:{price}, 5차추매가격{addprice_5}', file=fw)
                                    ...
                                    # upbit.buy_market_order(e, ag_price6)
                                    tb = ag_price6 / price          # volume : 매수수량 = 매수금액 / 현재가
                                    upbit.buy_limit_order(e, price, tb)         # 현재가 추매
                                    add_rw6(e, id); time.sleep(1)
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(5){now}:종목-6:{e}, 매수금액:{ag_price6}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, p:{price}, 6차추매가격{addprice_6}', file=fw)
                                    ...
                                    # upbit.buy_market_order(e, ag_price7)
                                    tb = ag_price7 / price          # volume : 매수수량 = 매수금액 / 현재가
                                    upbit.buy_limit_order(e, price, tb)         # 현재가 추매
                                    add_rw7(e, id); time.sleep(1)
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(6){now}:종목-7:{e}, 매수금액:{ag_price7}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, p:{price}, 7차추매가격{addprice_7}', file=fw)
                                    ...
                                    # upbit.buy_market_order(e, ag_price8)
                                    tb = ag_price8 / price          # volume : 매수수량 = 매수금액 / 현재가
                                    upbit.buy_limit_order(e, price, tb)         # 현재가 추매
                                    add_rw8(e, id); time.sleep(1)
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(7){now}:종목-8:{e}, 매수금액:{ag_price8}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, p:{price}, 8차추매가격{addprice_8}', file=fw)
                                    ...
                                    # upbit.buy_market_order(e, ag_price9)
                                    tb = ag_price9 / price          # volume : 매수수량 = 매수금액 / 현재가
                                    upbit.buy_limit_order(e, price, tb)         # 현재가 추매
                                    add_rw9(e, id); time.sleep(1)
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(8){now}:종목-9:{e}, 매수금액:{ag_price9}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, p:{price}, 9차추매가격{addprice_9}', file=fw)
                                    ...
                                    # upbit.buy_market_order(e, ag_price10)
                                    tb = ag_price10 / price          # volume : 매수수량 = 매수금액 / 현재가
                                    upbit.buy_limit_order(e, price, tb)         # 현재가 추매
                                    add_rw10(e, id); time.sleep(1)
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(9){now}:종목-10:{e}, 매수금액:{ag_price10}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, p:{price}, 10차추매가격{addprice_10}', file=fw)
                                    ...
                                    if (buy_goal5[1] < abp) and (price < buy_goal10[0]):
                                        ...
                                        with open('find_s%s.log' %(id),'a') as fw:
                                            print(f'{linenumber()}p::an(0){now}:종목:{e}, 매수금액:{ag_price1}, 추매수:{add_num[e][0:1]}', file=fw)
