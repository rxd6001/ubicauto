...
def ubic_sell(id):
    ...
    while True:
                    ...
                    if sell_cont == 0:          # (0) 전체 매도 제외, 전체 추매 제외
                        ...
                        if (sell_cont == 1) or (sell_cont == 3):          # 추매기능
                            if e in ext_a:
                                ...
                                # print(f'{linenumber()}p::추매지연(0)-{now}:종목 :{e}, 추매금액:{ag_price1}, 추매금액2:{ag_price2}, 추매금액3:{ag_price2}, an : {an}, ap : {ap},  t:{t_money}, b:{b_money}, 현재가:{price}, 1차추매가격:{addprice_1}, 2차추매가격:{addprice_2}, abp : {abp}')
                                ...
                                elif (an < ap) and (t_money <= (b_money * 1.1)) and (price < addprice_1) and (0.1 < addprice_1) and (5000 <= ag_price1) and (t_money < l_money) and (ag_price1 < summ):     # price: 종목현재가
                                ...
                                # elif (an == 2) and (an < ap) and (t_money < sum3) and (price < addprice_3) and (0.1 < addprice_3) and (5000 <= ag_price3) and (t_money < l_money)  and (ag_price3 < summ):
                                    ...
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(6){now}:종목-6:{e}, 전추:{ag_price5}, 추매금액:{ag_price6}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, p:{price}, 6차추매가격{addprice_6}', file=fw)
                                    ...
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(7){now}:종목-7:{e}, 전추:{ag_price6}, 추매금액:{ag_price7}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, p:{price}, 7차추매가격{addprice_7}', file=fw)
                                    ...
                                    with open('/root/UBiCauto/find_s%s.log' %(id),'a') as fw:
                                        print(f'{linenumber()}p::an(8){now}:종목-8:{e}, 전추:{ag_price7}, 추매금액:{ag_price8}, 추매수:{add_num[e][0:1]}, t:{t_money}, b:{b_money}, p:{price}, 8차추매가격{addprice_8}', file=fw)
        ...
        """ 가변 매도기준 켜고 / 끄기 """
        # ask_p = askper(upbit, 1)                   # 가변 매도기준 조정 및 저장
        """ ---------------------- """
